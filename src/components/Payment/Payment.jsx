...
function Payment() {
    return (
        <>
            <Back />
            <h2 className="text-xl font-semibold mb-10">Оплата и доставка</h2>
            <h3 className="text-md font-semibold mb-5">Оплата товаров:</h3>
            <MdPayment />
            <p> Мы принимаем оплату за наши товары следующими способами:</p>
            <ul className="text-md leading-8 mb-10 list-disc list-inside">
            ...
            <h3 className="text-md font-semibold mb-5">Доставка товаров:</h3>
            <CiDeliveryTruck />
